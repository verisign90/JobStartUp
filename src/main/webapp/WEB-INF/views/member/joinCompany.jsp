...
<body>
<h2>기업 회원가입</h2>
<form action="/join/company" method="post" onsubmit="return onSubmitForm();">
    <div>
        <label for="member_id">아이디</label>
        <input type="text" id="member_id" name="member_id" required oninput="checkDuplicate()"
    ...
    <div>
        ...
        <input type="text" id="member_name" name="member_name" required oninput="validateInput()" onblur="nameEmpty()"
               placeholder="이름 입력">
    ...
    <div>
        ...
        <input type="text" id="member_hp" name="member_hp" required pattern="^\d{3}\d{3,4}\d{4}$"
