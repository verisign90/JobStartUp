    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!"><img src="/img/jobstartup.png" style="width: 45%;"/></a>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <c:forEach var="applyDTO" items="${applyDTOList}">
                        <div class="col mb-5">
                            <div class="card h-100">
                                <!-- Product image-->
                                <img class="card-img-top" id="preview" src="${pageContext.request.contextPath}/printComLogo?company_no=${applyDTO.company_no}" alt="..." height="120"/>
                                <!-- Product details-->
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        <!-- Product name-->
                                        <h5 class="fw-bolder">${applyDTO.company_name}</h5>
                                        <!-- Product price-->
                                        <p> </p>
                                    </div>
                                </div>
