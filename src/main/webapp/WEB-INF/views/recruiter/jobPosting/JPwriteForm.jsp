...
<main>
    <article class="all-content">
        <div class="writeForm">
            <form action="${pageContext.request.contextPath}/recruiter/JPwrite" method="post"
                ...
                <section>
                    ...
                    <div>
                        <label for="business_type_code_up" class="business-code">직무</label>
                    </div>
                    <div>
                        <select class="business-select" id="business_type_code_up" name="posting_upperjobCode"
                                onchange="loadBusinessTypeCodeUp(0)" required>
