...
<main>
    <div class="wrap">
        ...
        <div class="d-flex justify-content-start mb-2" style="margin-left: 30px;">
        ...
        <c:if test="${todayList != null}">
            <div style="margin-left: 40px;"><img src="${cPath}/img/alarm.png" style="width:20px;" /> 오늘의 면접을 확인하세요.</div>
        </c:if>
        <div class="tab-content bg-transparent">
            <div id="note-full-container" class="note-has-grid row ml-4 mt-3 mb-5">
                <div class="col-md-4 single-note-item all-category" style="">
                    ...
                    <c:if test="${todayList eq null}">
                        <c:forEach items="${todayList}" var="todayInterview">
                            <c:forEach items="${todayInterview.companyDTOList}" var="company">
                                <div class="card card-body mx-2 ml-4">
                                    <span class="side-stick"></span>
                                    <h5 class="note-title text-truncate w-75 mb-0" data-noteheading="Book a Ticket for Movie">오늘 예정된 면접이 없습니다.<i class="point fa fa-circle ml-1 font-10"></i></h5>
                                    <p class="note-date font-12 text-muted">

                                    </p>
                                    <div class="note-content">
                                        <p class="note-inner-content text-muted" data-notecontent="Blandit tempus porttitor aasfs. Integer posuere erat a ante venenatis.">${member.member_name}님, 이력서를 지원하고 면접일정을 받아보세요 !</p>
                                    </div>
