            ...
            <div class="content_message">
                <div class="second-nav">
                    <div class="header">
                        <div class="title">
                            <h7>Message Box</h7>
                            <p><span class="userName"><sec:authentication property="name"/></span> 님에게 <span
                                    id="messageCnt"></span> 통의 쪽지가 도착했습니다.</p>
                        </div>
                    </div>
                    <div class="controls">
                    ...
                    <c:forEach var="message" items="${messageDTOPage.list}" varStatus="loop">
                        <div class="messages">
                            <div class="message">
                                <div class="cell">
                                    <div class="checkbox">
                                        <input type="checkbox" name="${message.mes_no}" id="${message.mes_no}"
                                               value="${message.mes_no}"/>
                                        <label class="checkbox_label" for="${message.mes_no}"></label>
                                    </div>
                                    <div class="message_metadata">
                                        <div class="mes-no" id="mes_no_${loop.index}"
                                             data-mes-no="${message.mes_no}"></div>
                                        ...
                                        <c:choose>
                                            <c:when test="${message.mes_content.length()<30}">
                                                <p class="d-flex justify-content-between" id="content_p">
                                                    ...
                                                    <span>
                                    <fmt:parseDate value="${message.mes_regDate}" pattern="yyyy-MM-dd'T'HH:mm:ss"
                ...
                <div class="viewer" id="viewer">
                    <div class="scroll">
                        <div id="checkMessage">
                            <div class="d-flex justify-content-center"><img src="${cPath}/img/message/send-mail.png"
