...
<article class="question">
    <section class="contents">
        <h4>문의 내역</h4>
        <div class="inner">
            <h3 class="sans">1:1 문의 내역이 <span class="blue">${questionPage.pagination.totalRecordCount}</span>건 있습니다.
            </h3>
            <div class="acco">
            ...
            <div class="a">
                ...
                <div class="answerDiv" id="answerDiv-${question.q_no}">
                    <c:choose>
                        <c:when test="${empty question.answerDTO}">
                            <strong>답변대기</strong>
                            <p>아직 질문에 답변이 달리지 않았습니다. 영업일 기준 3일 이내로 회신드립니다. <span class="answerBtn"><button type="button"
                                                                                                           onclick="answerForm(${question.q_no})">답글달기</button></span>
                            </p>
                        </c:when>
                        <c:otherwise>
                            <strong>답변완료</strong>
