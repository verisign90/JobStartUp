    ...
    <article>
        ...
        <div>
            <form method="post" action="${pageContext.request.contextPath}/admin/jobfair/save"
                ...
                <label for="hiddenContent"></label>
                <textarea name="JOBFAIR_CONTENT" id="hiddenContent" style="display:none;"></textarea>
                <div>
...
<script>
    let editor; // 전역 범위에서 에디터 변수를 선언합니다.
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        ClassicEditor
            ...
            .then(createdEditor => {
                editor = createdEditor; // 에디터 인스턴스를 전역 변수에 할당합니다.
    ...
    document.querySelector('form').addEventListener('submit', function () {
        if (editor) {
            // 에디터 변수가 정의되어 있으면 에디터의 내용을 가져옵니다.
