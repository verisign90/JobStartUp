...
public class AppManageServiceImpl implements AppManageService{
    ...
    public void sendMailFirstEnroll(String member_email){
        ...
        simpleMailMessage.setText("안녕하세요. 채용 담당자입니다. 모집에 관심을 갖고 지원해주셔서 진심으로 감사 드립니다.\n" +
                "\n" +
                "공채 서류전형 결과 보고 드립니다. 서류전형 \"합격\"을 축하 드립니다.\n" +
                "\n" +
                "진행 방법은 이후 별도로 문자 안내 드리겠습니다.\n" +
    ...
    public void sendMailFirstDenial(String member_email){
        ...
        simpleMailMessage.setText("안녕하세요. 채용 담당자입니다. 모집에 관심을 갖고 지원해주셔서 진심으로 감사 드립니다.\n" +
                "\n" +
                "서류 전형 발표 후 다시 연락드리기 죄송한 마음도 있지만, 귀한 시간 내어 지원해주신 분들께 감사 인사를 드리는 것이 예의일 것 같아 연락 드립니다.\n" +
                "\n" +
                ...
                "\n" +
                "비록 이번에는 좋은 만남을 이어나갈 수 없게 되었지만, 이후 더욱 성장한 모습으로 다시금 만날 수 있기를 진심으로 바랍니다. 저희도 더욱 성장하여 다음 기회에는 많은 분들을 모실 수 있도록 하겠습니다.\n");
        simpleMailMessage.setFrom("test@test.com");
        simpleMailMessage.setTo(member_email);
        javaMailSender.send(simpleMailMessage);
    }
    ...
    public void sendMailLastEnroll(String member_email) {
        ...
        simpleMailMessage.setText("안녕하세요. 채용 담당자입니다. 모집에 관심을 갖고 지원해주셔서 진심으로 감사 드립니다.\n" +
                "\n" +
                "공채 최종 면접 전형 발표 결과 보고 드립니다. 최종 \"합격\"을 축하 드립니다.\n" +
                "\n" +
    ...
    public void sendMailLastDenial(String member_email) {
        ...
        simpleMailMessage.setText("안녕하세요. 채용 담당자입니다. 모집에 관심을 갖고 지원해주셔서 진심으로 감사 드립니다.\n" +
                "\n" +
                "최종 면접 전형 발표 후 다시 연락드리기 죄송한 마음도 있지만, 귀한 시간 내어 지원해주신 분들께 감사 인사를 드리는 것이 예의일 것 같아 연락 드립니다.\n" +
                "\n" +
                ...
                "\n" +
                "비록 이번에는 좋은 만남을 이어나갈 수 없게 되었지만, 이후 더욱 성장한 모습으로 다시금 만날 수 있기를 진심으로 바랍니다. 저희 더욱 성장하여 다음 기회에는 많은 분들을 모실 수 있도록 하겠습니다.\n");
        simpleMailMessage.setFrom("test@test.com");
        simpleMailMessage.setTo(member_email);
        javaMailSender.send(simpleMailMessage);
    }
